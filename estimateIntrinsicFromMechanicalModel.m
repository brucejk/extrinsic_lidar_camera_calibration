function  [delta, plane, valid_targets] = estimateIntrinsicFromMechanicalModel(num_beams, num_targets, num_scans, data_split_with_ring, data_split_with_ring_cartesian, object_list)
